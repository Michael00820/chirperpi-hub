...
const stats = [
  { label: 'Pioneers', value: '12K+' },
  { label: 'Active Groups', value: '430' },
  { label: 'Proposals', value: '180' },
  { label: 'Pi Tipped', value: '94K π' }
]
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
          ...
          <div className="border-t border-slate-200 bg-white md:hidden">
            <div className="mx-auto flex max-w-6xl flex-col px-4 py-2 text-sm font-medium text-slate-700">
              ...
              <Link
                ...
                className="my-2 rounded-lg bg-indigo-600 px-4 py-3 text-center text-white"
              >
                Get Started
              </Link>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-16 sm:px-6">
        <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 via-violet-600 to-fuchsia-600 p-8 text-center text-white shadow-xl sm:p-12">
          <h3 className="text-2xl font-bold sm:text-3xl">Ready to join the conversation?</h3>
          <p className="mx-auto mt-3 max-w-xl text-sm text-indigo-100 sm:text-base">
            Set up your profile in under a minute and start connecting with the Pi community.
          </p>
          <Link
            to="/onboarding"
